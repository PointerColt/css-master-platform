...
- [x] Created a flow chart container (`fc-container`) and design it using grid and flexbox
- [x] created a tree structure conatainr (`tree-structure`) with using ul li nesting
- [x] change the image (`architecture.png`) with another image in topic 1.1
...
- [x] **Topic 1.4: Connecting CSS to HTML** — complete
- [x] **Topic 1.5: DevTools Diagnostics** — complete
- [x] **Topic 1.6: CSS Comments** — complete
- [x] **Topic 2.1: The CSS Cascade** — complete
- [x] **Topic 2.2: Value Inheritance** — complete
- [x] **Topic 2.3: Calculations of Specificity** — complete
- [x] **Topic 2.4: Selector Chaining** — complete


## next target
- [x] **Topic 3.1 Fundamental Selectors**
...
- 1.4 Connecting CSS to HTML (Inline attributes, internal style tags, and external link tags) — ✅ done 
- 1.5 DevTools Diagnostics (Inspect element panel, temporary stylesheet testing, and typo flags) — ✅ done 
- 1.6 CSS Comments (Single-line vs. multi-line comments and closure pitfalls) — ✅ done 

**Chapter 2: The Cascade, Specificity, and Inheritance**
- 2.1 The CSS Cascade (Sorting styles by origin, explicit weight, specificity, and source order) — ✅ done 
- 2.2 Value Inheritance (Typography auto-inheritance vs. layout block boundaries) — ✅ done 
- 2.3 Calculations of Specificity (The ABCD specificity columns vs. the points-scale myth) — ✅ done 
- 2.4 Selector Chaining (Targeting elements carrying multiple classes, e.g., `.urgent.warning`) — ✅ done
