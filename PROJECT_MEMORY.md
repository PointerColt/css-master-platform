...
- [x] **Topic 1.5: Connecting CSS to HTML** — complete
- [x] **Topic 1.6: Connecting CSS to HTML** — complete
- [x] **Topic 2.1: Connecting CSS to HTML** — complete
- [x] **Topic 2.2: Connecting CSS to HTML** — complete
- [x] **Topic 2.3: Connecting CSS to HTML** — complete

## next target
- [] **Topic 2.4: Connecting CSS to HTML** 
